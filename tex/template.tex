...
%+++++++++++++++++++++++++++++++++++++++++++
\title{\LARGE An Argument for Bi-Modal Defence Infrastructure)}
%+++++++++++++++++++++++++++++++++++++++++++
...
\author{\authorblockN{Dr. C. Darling}
\authorblockA{School of Electrical and\\Computer Engineering\\
Sandia National Laborotories\\
Albuquerque, New Mexico\\
Email: cdarling@sandia.gov}
}

\and

\author{\authorblockN{Dr. Isaac Kleiner}
\authorblockA{B\\
Massachusetts Institute of Technology\\
Cambridge, Massachusetts.\\
Email: issacqkleiner@mit.gov.uk}
}
...
\begin{abstract}
This paper presents an argument that 4th Generatiion mobile technoloogy provide the basis of a next-generation defense matrix. A system which leverages inftastructure primarily intended to service conusumer applications can achieve greater urban penetration, while lowering operational costs. The authors argue that such a system is feasable within a decade.
\end{abstract}
\IEEEoverridecommandlockouts
\begin{keywords}
Ceramics, resonance cascade, type-two Feldman loops, delay-lines, power
amplifiers.
\end{keywords}
% no keywords
