...
\author{Dr Casper Darling,~\IEEEmembership{Member,~IEEE,}
        Gordon Freeman,~\IEEEmembership{Fellow,~OSA,}
        C Xavier,~\IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
...
% The paper headers
\markboth{Journal of \LaTeX\ Class Files,~Vol.~14, No.~8, August~2004}%
...
\begin{IEEEbiography}{Casper Darling}
Dr Casper Darling is a senior research fellow at the Federal Board of Control.
\end{IEEEbiography}
