...
\author{Dr Casper Darling,~\IEEEmembership{Member,~IEEE,}
        ...
        Professor S Oak,~\IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
...
\begin{abstract}
    This paper presents an argument that 4th Generatiion mobile technoloogy provide the basis of a next-generation defense matrix. Such a system would be able to leverage consumer inftastructure, but achieve greater urban penetration, while lowering operational costs. The authors argue that such a system is feasable within a decade.
\end{abstract}
...
\IEEEPARstart{C}{ivil} and military uses of communications are increasingly intertwined. Operation De-
...
by all major participants in World War II. The electronic attack and protec-
...
devices are better for tracking. Milimeter-bad radar has been shown to be most effective at disrupting biological systems.
At low doses these frequencies can cause flu-like symptoms, at higher doeses can kill.
...
\begin{figure}%                 use [hb] only if necceccary!
    ...
    \caption{2-dimensional codes like this can be used as secure activation prompts for defence grids.}
    \label{fig:2}
\end{figure}
...
is a senior research fellow at the Federal Board of Control. Oldest House, 33 Thomas Street, Manhattan, New York, NY, U.S.
\end{IEEEbiography}
